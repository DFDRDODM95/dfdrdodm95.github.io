...
updated : 2025-01-11 00:29:10 +0900
tag     : 
toc     : true
public  : true
parent  : 
...
* [X] Docker 컨테이너 배포하기
* [X] 더 복잡한 설정:Laravel & PHP 도커화 프로젝트
* [X] "유틸리티 컨테이너"로 작업하기 & 컨테이너에서 명령 실행하기
* [X] Docker Compose: 우아한 다중 컨테이너 오케스트레이션
* [X] Docker로 다중 컨테이너 애플리케이션 구축하기
* [X] 네트워킹:(교차)컨테이너 통신
* [X] 데이터 관리 및 볼륨으로 작업하기
* [X] 섹션 2. Docker 이미지 & 컨테이너:코어 빌딩 블록
* [X] 섹션 1. 시작하기

## 백엔드 애플리케이션 성능 개선하기 - 기초편
* [X] 섹션 4. 부록
    * [X] 2024-07-08 실습을 모두 마쳤다면 꼭 인스턴스를 제거하세요
    * [X] 2024-07-08 ngrinder를 사용하여 테스트하기
* [X] 섹션 3. 단축 URL 조회 API 성능 개선하기
    * [X] 2024-07-08 조회 API 개선 방법 고민해보기
    * [X] 2024-07-08 인덱스 추가
    * [X] 2024-07-08 캐시를 활용한 성능 개선
    * [X] 2024-07-08 redirectCount 증가를 모아서 처리하기
* [X] 섹션 2. 단축 URL 생성 API 성능 개선하기
    * [X] 2024-07-08 생성 API 성능 개선 방법 고민해보기
    * [X] 2024-07-08 요청 처리 스레드 수 늘리기
    * [X] 2024-07-08 서버 사이즈 키우기
    * [X] 2024-07-08 응답과 생성을 분리하기
* [X] 섹션 1. 단축 URL 서비스 성능 측정하기
    * [X] 2024-07-07 단축 URL 애플리케이션 코드 확인하기
    * [X] 2024-07-08 서버에 배포하기
    * [X] 2024-07-08 생성 API 성능 측정하기
    * [X] 2024-07-08 조회 API 성능 측정하기
* [X] 섹션 0. 백엔드 애플리케이션 성능 개선하기 - 기초편
    * [X] 2024-07-07 강의 소개
    * [X] 2024-07-07 이전 강의 내용 간단 요약
    * [X] 2024-07-07 실습 환경
