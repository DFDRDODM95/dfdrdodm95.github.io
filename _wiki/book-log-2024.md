...
updated : 2024-07-14 11:45:38 +0900
tag     : 
toc     : true
public  : true
parent  : 
...
## SQL 전문가 가이드
* [X] 과목 3. SQL 고급 활용 및 튜닝
    * [X] 제7장 LOCK과 트랜잭션 동시성 제
        * [X] 2024-05-17 제1절 LOCK
        * [X] 2024-05-17 제2절 트랜잭션
        * [X] 2024-05-17 제3절 동시성 제어
        * [X] 2024-05-17 장 요약
    * [X] 제3장 인덱스 튜닝
        * [X] 2024-07-13 제1절 인덱스 기본 원리
        * [X] 2024-07-14 테이블 액세스 최소화
        * [X] 2024-07-14 인덱스 스캔 효율화
        * [X] 2024-07-14 인덱스 설계
    * [X] 제2장 SQL 분석 도구
        * [X] 2024-07-12 제1절 예상 실행계획
        * [X] 2024-07-12 제2절 SQL 트레이스
        * [X] 2024-07-12 제3절 응답 시간 분석
    * [X] 제1장 SQL 수행 구조
        * [X] 2024-07-12 제1절 데이터베이스 아키텍처
        * [X] 2024-07-12 제2절 SQL 처리 과정
        * [X] 2024-07-12 제3절 데이터베이스 I/O 메커니즘

## 단위 테스트
* [X] 11장 단위 테스트 안티 패턴
    * [X] 2024-04-29 11.1 비공개 메서드 단위 테스트
    * [X] 2024-04-29 11.2 비공개 상태 노출
    * [X] 2024-04-29 11.3 테스트로 유출된 도메인 지식
    * [X] 2024-04-29 11.4 코드 오염
    * [X] 2024-04-29 11.5 구체 클래스를 목으로 처리하기
    * [X] 2024-04-29 11.6 시간 처리하기
    * [X] 2024-04-29 11.7 결론
* [X] 10장 데이터베이스 테스트
    * [X] 2024-04-28 10.1 데이터베이스 테스트를 위한 전제 조건
    * [X] 2024-04-28 10.2 데이터베이스 트랜잭션 관리
    * [X] 2024-04-29 10.3 테스트 데이터 생명 주기
    * [X] 2024-04-29 10.4 테스트 구절에서 코드 재사용하기
    * [X] 2024-04-29 10.5 데이터베이스 테스트에 대한 일반적인 질문
    * [X] 2024-04-29 10.6 결론
* [X] 9장 목 처리에 대한 모범 사례
...
## 자바 ORM 표준 JPA 프로그래밍
* [X] 16장 트랜잭션과 락, 2차 캐시
    * [X] 2024-07-11 16.1 트랜잭션과 락
    * [X] 2024-07-11 16.2 2차 캐시
    * [X] 2024-07-11 16.3 정리
* [X] 9장, 값 타입
...
* [o] 15장, 고급 주제와 성능 최적화
    ...
    * [ ] 15.2 엔티티 비교
    * [ ] 15.3 프록시 심화 주제
    * [X] 2024-07-01 15.4 성능 최적화
    * [X] 2024-07-01 15.5 정리
* [X] 16장, 트랜잭션과 락, 2차 캐시
    * [X] 2024-07-01 16.1 트랜잭션과 락
    * [X] 2024-07-01 16.2 2차 캐시
    * [X] 2024-07-01 16.3 정리
